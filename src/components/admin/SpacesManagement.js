...
function SpacesManagement({userRef, newSpace}) {
    ...
    if (selectedSpace)
      return (
        <SpaceDetails selectedSpace={selectedSpace} setSelectedSpace={setSelectedSpace} />
      );
    ...
    const {name, image, description, location, price} = datas
  return (
    ...
    <div className='admin-spaces-display'>
        ...
        <div className='space-div'>
            {datas.map(space=>{
                return(
                    <div className="space-card" key={space.id} onClick={()=>setSelectedSpace(space)}>
                        ...
                        <div className="space-card-content">
                            ...
                            <p className="space-card-price">${space.price} /hr</p>
                        </div>
                    </div>
            )})}
        </div>
