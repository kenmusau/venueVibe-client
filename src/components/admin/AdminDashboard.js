      ...
      <div className="center">
        ...
        <div className="stats">
          <div className="spaces-stats">
            ...
            <p>
              Occupied spaces: <span id="span-occupied">50</span>
            </p>
            <p>
              Vacant spaces: <span id="span-vacant">25</span>
            </p>
          </div>
          <div className="users-stats">
            ...
            <p>
              Active users: <span id="span-occupied">20</span>
            </p>
            <p>
              New users: <span id="span-vacant">10</span>
            </p>
          </div>
        </div>
